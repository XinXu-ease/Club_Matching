...
const CLUBS_DB = {
  'drama': {
    ...
    // 问答
    qa: [
      { q: '如何申请加入社团？', a: '可以在招新期间通过提交报名表和参加面试来加入。面试通常包括一段表演展示或自我介绍。' },
      { q: '需要有表演经验吗？', a: '不需要！我们欢迎零基础的同学。社团会提供详细的培训和指导。' },
      { q: '每周需要投入多少时间？', a: '通常为3-5小时，主要是周三晚上的例会。如果参与演出会需要更多排练时间。' },
      { q: '社团会参加比赛吗？', a: '会的！我们每学期举办2次公开演出，还会参加校级和市级的戏剧比赛。' }
    ],
  ...
  'photo': {
    ...
    // 问答
    qa: [
      { q: '一定要有自己的相机吗？', a: '不一定。社团会教授基础摄影知识，也可以用手机拍摄。有相机的同学优先进入高阶班。' },
      { q: '招新时需要提交作品吗？', a: '是的，招新时需要提交5-10张个人作品或手机摄影作品展示你的风格。' },
      { q: '社团会教后期修图吗？', a: '会的！修图技巧分享是我们的核心课程，包括Lightroom、Photoshop等工具。' },
      { q: '活动的照片可以用于其他地方吗？', a: '当然可以。社团的照片归原摄影者所有，你可以自由使用。' }
    ],
  ...
  'coding': {
    ...
    // 问答
    qa: [
      { q: '我是初学者可以加入吗？', a: '可以，但需要有基本的编程基础或强烈学习意愿。我们会提供进阶培训。' },
      { q: '社团会帮助参加竞赛吗？', a: '完全会！我们有完整的竞赛集训计划，包括ACM、蓝桥杯等。' },
      { q: '是否需要自己的电脑？', a: '是的，需要配置一台可以运行IDE的电脑（通常配置不需要太高）。' },
      { q: '参加开源项目实战需要什么？', a: '需要了解Git、GitHub基本使用，以及至少一种编程语言。我们会在项目中进一步培训。' }
    ],
  ...
  'green': {
    ...
    // 问答
    qa: [
      { q: '不懂环保知识可以加入吗？', a: '完全可以！社团会从基础教起，包括垃圾分类、可持续发展等知识。' },
      { q: '参加志愿活动会很累吗？', a: '我们的活动设计得很有趣且轻松。通常是周末进行，强度适中。' },
      { q: '社团有什么校外合作吗？', a: '有的。我们与校内外多个环保组织和社区合作，参与真实的环保项目。' },
      { q: '志愿服务可以累计时数吗？', a: '可以。所有参与者的志愿时数都会被记录，可用于综合测评或升学。' }
    ],
